    ...
    <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
      ...
      <div className="p-5">
          <div className="grid grid-cols-3 gap-1">
              ...
              <button type="button" onClick={() => signIn("google")} className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Google</button>
              <button type="button" onClick={() => signIn("github")} className="transition duration-200 border border-gray-200 text-gray-500 w-full py-2.5 rounded-lg text-sm shadow-sm hover:shadow-md font-normal text-center inline-block">Github</button>
          </div>
      </div>
        <div className="py-5">
